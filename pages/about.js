    ...
    <Box backgroundColor="#fcf7f2">
      ...
      <Box className={styles.about}>
        ...
        <Box className={styles.aboutText}>
          ...
          <Box className={styles.innerAboutText}>
            <Text>
              ...
              everyone together for an event and see the look on their faces
              shows me how beautifully things can come together. This made me
              realize I wanted to share that with the world.
            </Text>
            <Text>
              I welcome you Simply Together Events. I offer event planning,
              event design, luxury picnics, and party rentals. For whatever you
              may need for your upcoming event, I am here to do it all. I am
              happy that my wide expansion of services can carter to some of the
              biggest events and most intimate moments with your loved ones. I
              am here to provide a stress-free, fun, and beautiful gatherings
              for anyone.
            </Text>
